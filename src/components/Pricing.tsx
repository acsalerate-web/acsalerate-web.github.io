  ...
  const plans = [
    {
      name: "Starter",
      price: "Free",
      description: "Individual Reps & Small Teams",
      features: [
        "Voice-enabled notes and CRM sync",
    ...
    },
    {
      name: "Enterprise",
      price: "Custom",
      description: "Large Organizations & Enterprises",
      features: [
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-medium tracking-tighter text-foreground">
            Choose your AI sales acceleration plan
          </h2>
          <p className="text-muted-foreground text-lg">
            Transform your sales process with AI-powered tools that grow with your team
          </p>
        </div>
